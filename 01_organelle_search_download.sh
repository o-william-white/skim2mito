...
#SBATCH --output=job_organelle_search_download_%j_%a.out
#SBATCH --error=job_organelle_search_download_%j_%a.err
...
mkdir -p organelle_search_download
...
python additional_scripts/organelle_search_ncbi.py \
   ...
   --action download \
   --max_n 5 \
   --output organelle_search_download/${REF} \
   --overwrite
